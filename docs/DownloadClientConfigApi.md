# radarr.DownloadClientConfigApi
...
with radarr.ApiClient(configuration) as api_client:
    ...
    api_instance = radarr.DownloadClientConfigApi(api_client)
...
with radarr.ApiClient(configuration) as api_client:
    ...
    api_instance = radarr.DownloadClientConfigApi(api_client)
    id = 'id_example' # str | 
    download_client_config_resource = radarr.DownloadClientConfigResource() # DownloadClientConfigResource |  (optional)
