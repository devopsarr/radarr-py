...
class ImportListExclusionResource(BaseModel):
    ...
    presets: Optional[List[ImportListExclusionResource]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "presets": [ImportListExclusionResource.from_dict(_item) for _item in obj["presets"]] if obj.get("presets") is not None else None,
...
ImportListExclusionResource.model_rebuild(raise_errors=False)
