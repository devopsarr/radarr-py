...
class ManualImportResource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "path", "relativePath", "folderName", "name", "size", "movie", "movieFileId", "releaseGroup", "quality", "languages", "qualityWeight", "downloadId", "customFormats", "customFormatScore", "indexerFlags", "rejections"]
